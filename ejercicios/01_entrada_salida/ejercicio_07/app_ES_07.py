...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        alert(title="Ej 07 suma",message=f"El resultado de la suma es: {int(self.txt_operador_a.get()) + int(self.txt_operador_b.get())}")

    def btn_restar_on_click(self):
        alert(title="Ej 07 resta",message=f"El resultado de la resta es: {int(self.txt_operador_a.get()) - int(self.txt_operador_b.get())}")    

    def btn_multiplicar_on_click(self):
        alert(title="Ej 07 multiplicacion",message=f"El resultado de la multiplicacion es: {int(self.txt_operador_a.get()) * int(self.txt_operador_b.get())}")     

    def btn_dividir_on_click(self):
        alert(title="Ej 07 division",message=f"El resultado de la division es: {int(self.txt_operador_a.get()) / int(self.txt_operador_b.get())}")   
